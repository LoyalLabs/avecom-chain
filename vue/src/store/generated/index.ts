...
import LoyalLabsAvecomChainLoyalLabsAvecomchainAvecomchain from './LoyalLabs/avecom-chain/LoyalLabs.avecomchain.avecomchain'
...
export default { 
  LoyalLabsAvecomChainLoyalLabsAvecomchainAvecomchain: load(LoyalLabsAvecomChainLoyalLabsAvecomchainAvecomchain, 'LoyalLabs.avecomchain.avecomchain'),
